...
const About = () => {
  return (
    <Layout>
      ...
      <section>
        <div>
          <h1 className="mt-12 text-3xl text-center font-bold text-blue-800">
            What is igedla? (pronounced eye-ged-la)
          </h1>
          <p className="mt-2 px-8 py-2 text-3x1 text-gray-700 font-semibold">
            Igedla is a personalized health information company and offers a free, HIPAA-compliant
            app that is available nationwide on
            <span className="text-blue-500"> iOS </span>
            and
            <a
              href="https://play.google.com/store/apps/details?id=com.igedla.health"
          ...
          <p className="mt-4 px-8 py-2 text-gray-700 font-semibold">
            {' '}
            The app’s AI references a history of diagnoses and treatments to deliver users an
            insight about how their condition would likely be treated. Our ‘Possible Causes’ engine
            is unique in being able to handle large and complex medical presentations using multiple
            AI and enhanced machine learning algorithms while remaining quick and easy to use.
          </p>
        </div>
      </section>
                ...
                <label className="flex flex-col rounded-lg shadow-lg group relative cursor-pointer hover:shadow-2xl-blue">
                  <div className="w-full px-4 py-6 rounded-t-lg card-section-1">
                    ...
                    <p className="text-md font-bold font-roboto text-center group-hover:text-white text-blue-500">
                      Understand your symptoms and risks of COVID-19 with Igedla's free Coronavirus
                      assessment tool
                    </p>
                ...
                <label className="flex flex-col rounded-lg shadow-lg relative cursor-pointer hover:shadow-2xl-blue">
                  <div className="w-full px-4 py-8 rounded-t-lg bg-blue-500">
                    ...
                    <p className="text-md font-bold font-roboto text-center text-white">
                      Igedla asks simple, relevant questions to help you understand symptoms
                      concerning you or your kids and gives you immediate answers you can trust.
                    </p>
